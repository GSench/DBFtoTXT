...
public class DbfReader implements Closeable {
    ...
    public DbfReader(File file) throws DbfException {
        try {
            ...
            throw new DbfException("Cannot open Dbf path " + file, e);
        }
    }
    ...
    public Object[] nextRecord() {
        try {
            ...
            return null; // we currently end reading path
        } catch (IOException e) {
            throw new DbfException("Cannot read next record form Dbf path", e);
        }
    }
